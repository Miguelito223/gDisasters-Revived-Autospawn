...
CreateConVar( "gdisasters_autospawn", "0", {FCVAR_ARCHIVE,FCVAR_NOTIFY}, "" )
CreateConVar( "gdisasters_autospawn_disasters", "0", {FCVAR_ARCHIVE,FCVAR_NOTIFY}, "" )
CreateConVar( "gdisasters_autospawn_weather", "0", {FCVAR_ARCHIVE,FCVAR_NOTIFY}, "" )
CreateConVar( "gdisasters_autospawn_weatherdisaster", "0", {FCVAR_ARCHIVE,FCVAR_NOTIFY}, "" )
...
local function WeatherDisasterspawn()
	...
	local weadisas = {
		...
		"gd_w1_highpressure_sys",
		"gd_w2_lowpressure_sys",
		"gd_w3_hurricanic_lowpressure_sys","gd_w4_dryline",
		"gd_w4_derecho",
		"gd_w4_strong_coldfront",
		"gd_w4_strong_occludedfront",
		"gd_w4_strong_warmfront",
